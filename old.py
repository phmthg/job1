...
class JobSpider(scrapy.Spider):
    ...
    def start_requests(self):
        yield scrapy.Request(url='https://careerbuilder.vn/viec-lam/ngay-cap-nhat-d1-vi.html',
                             callback=self.parse,
                             headers={
    ...
    def parse_job(self, response):
        ...
        bang_cap= response.xpath("//section[@class='job-detail-content']/div[5]/div/ul/li[contains(text(), 'Bằng cấp')]/text()").get() 
