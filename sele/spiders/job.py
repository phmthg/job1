...
class JobSpider(scrapy.Spider):
    ...
    start_urls = ["https://careerbuilder.vn/viec-lam/dang-trong-1ngay-d1-vi.html"] # 11/03/2021
    ...
    def parse_job(self, response):
        ...
        # start_index_age = age.find(":") + 1
        # end_index_age = age.find("</li>")
        # age = age[start_index_age:end_index_age].strip() 
        ...
        # start_index = edu_level.find(":") + 1
        # end_index = edu_level.find("</li>")
        # edu_level = edu_level[start_index:end_index].strip() 
